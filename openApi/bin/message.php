...
function receiveMsgFromQyWx()
{
    ...
    if ($errCode == 0) {
        ...
        $a = $ToUserName . $FromUserName . $CreateTime . $MsgType . $Content . $MsgId;

        file_put_contents("E:/test.txt", $a);
        ...
        $sRespData = sprintf($sRespData, $FromUserName, $corpId, $a);
